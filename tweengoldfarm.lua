...
----------------------------------------------------------------
local waypoints = {
    {Vector3.new(-145.35, -34.47, -161.18), 4.2},
    {Vector3.new(-109.24, -24.17, -187.50), 4.2},
    {Vector3.new(-128.69, -35.00, -183.10), 0.2},
    {Vector3.new(-141.02, -11.87, -188.26), 0.1},
    {Vector3.new(-126.94, -7.79, -206.08), 4.2},
    {Vector3.new(-126.00, -3.75, -215.39), 0.1},
    {Vector3.new(102.89, -3.00, -326.25), 0.1},
    {Vector3.new(186.08, -3.47, -233.67), 0.1},
    {Vector3.new(223.61, -3.00, -204.31), 0.1},
    {Vector3.new(461.60, 16.56, 142.94), 0.1},
    {Vector3.new(475.04, 12.85, 150.14), 4.2},
    {Vector3.new(504.06, 12.74, 188.21), 0.1},
    {Vector3.new(470.37, 11.96, 235.59), 4.2},
    {Vector3.new(663.29, 32.85, -186.40), 4.2},
    ...
    {Vector3.new(677.09, 78.95, -381.96), 4.2},
    {Vector3.new(633.86, 48.47, -357.08), 0.2},
    {Vector3.new(580.62, 13.45, -350.00), 0.2},
    {Vector3.new(609.73, -6.18, -353.38), 4.2},
    {Vector3.new(622.33, -6.21, -359.16), 4.2},
    {Vector3.new(636.71, -7.20, -375.39), 4.2},
    {Vector3.new(613.61, -6.25, -384.32), 4.2},
    {Vector3.new(557.05, 11.62, -393.43), 0.2},
    {Vector3.new(-79.71, 5.00, -533.88), 0.2},
    {Vector3.new(-212.27, 25.33, -625.94), 4.2},
    ...
    {Vector3.new(-208.41, -61.63, -626.84), 4.2},
    {Vector3.new(-177.84, -64.19, -608.29), 0.2},
    ...
    {Vector3.new(37.75, -99.08, -370.12), 4.2},
    {Vector3.new(56.27, -98.64, -358.45), 4.2},
    ...
    {Vector3.new(-245.45, -82.74, -245.67), 4.2},
    {Vector3.new(-224.83, -83.06, -259.45), 0.1},
    {Vector3.new(-245.03, -74.41, -297.54), 0.2},
    {Vector3.new(-252.99, -74.54, -314.63), 0.1},
    {Vector3.new(-303.95, -75.70, -371.95), 4.2},
    {Vector3.new(-252.99, -74.54, -314.63), 0.1},
    {Vector3.new(-245.03, -74.41, -297.54), 0.2},
    {Vector3.new(-224.83, -83.06, -259.45), 0.1},
