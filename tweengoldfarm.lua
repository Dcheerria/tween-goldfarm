...
local waypoints = {
    ...
    {Vector3.new(-128.69, -35.00, -183.10), 0.1, false},
    ...
    {Vector3.new(453.57, 6.36, 139.23), 0.1, false},
    ...
    {Vector3.new(509.99, 12.53, 164.11), 0.1, false},
    {Vector3.new(519.12, -3.00, 147.19), 0.1, false},
    {Vector3.new(621.35, -3.27, -143.44), 0.1, false},
    {Vector3.new(624.31, 18.55, -164.57), 0.1, false},
    {Vector3.new(467.13, 15.30, 238.22), nil, true},
    {Vector3.new(697.37, 27.11, -182.30), 0.1, false},
    {Vector3.new(727.39, 24.90, -221.17), 0.1, false},
    {Vector3.new(740.64, 20.49, -277.09), 0.1, false},
    {Vector3.new(678.81, 52.51, -317.05), 0.1, false},
    {Vector3.new(682.06, 80.56, -372.30), 0.1, false},
    {Vector3.new(677.09, 78.95, -381.96), nil, true},
    {Vector3.new(633.86, 48.47, -357.08), 0.1, false},
    {Vector3.new(580.62, 13.45, -350.00), 0.1, false},
    ...
    {Vector3.new(557.05, 11.62, -393.43), 0.1, false},
    {Vector3.new(-79.71, 5.00, -533.88), 0.1, false},
    {Vector3.new(-212.27, 25.33, -625.94), nil, true},
    {Vector3.new(-291.56, -39.85, -678.88), 0.1, false},
    {Vector3.new(-226.31, -38.97, -633.08), 0.1, false},
    {Vector3.new(-149.40, -23.31, -563.70), 0.1, false},
    {Vector3.new(-118.20, -39.51, -611.25), 0.1, false},
    {Vector3.new(-146.85, -54.88, -631.76), 0.1, false},
    {Vector3.new(-177.84, -64.19, -608.29), 0.1, false},
    {Vector3.new(-208.41, -61.63, -626.84), nil, true},
    {Vector3.new(-177.84, -64.19, -608.29), 0.1, false},
    {Vector3.new(-158.42, -64.82, -591.58), 0.1, false},
    {Vector3.new(-175.88, -63.80, -553.14), 0.1, false},
    {Vector3.new(-164.27, -63.02, -521.57), 0.1, false},
    {Vector3.new(-190.30, -66.24, -464.96), 0.1, false},
    {Vector3.new(-91.88, -103.00, -425.60), 0.1, false},
    ...
    {Vector3.new(-87.45, -102.32, -431.01), 0.1, false},
